...
pub use device_profile::{
    ...
    resolve_device_id, resolve_device_profile_path, sanitize_device_id, summarize_device_profile,
    DeviceGuidanceProfile, DeviceHealthProfile, DeviceLaunchProfile, DevicePathHints,
    DeviceProfile, DeviceProfileSummary, DeviceReportRoots, DeviceServiceTemplate,
