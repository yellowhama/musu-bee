            ...
            try {
                ...
                if ($readmeEntry) {
                    ...
                    Add-CheckFromCondition `
                        ...
                        ($kitReadme -like "*measure-musu-runtime-cpu-scenarios.ps1*" -and $kitReadme -like "*musu.runtime_cpu_scenario_matrix.v1*" -and $kitReadme -like "*startup-open*" -and $kitReadme -like "*runtime-started*" -and $kitReadme -like "*dashboard-open*" -and $kitReadme -like "*desktop-open*" -and $kitReadme -like "*post-route*" -and $kitReadme -like "*RunRouteProbe*" -and $kitReadme -like "*.local-build\runtime-cpu-scenarios\*" -and $kitReadme -like "*cpu_attribution*" -and $kitReadme -like "*top_processes*") `
                        "kit README explains runtime CPU scenario matrix diagnostics and PID/role attribution" `
                        "kit README does not explain runtime CPU scenario matrix diagnostics or CPU attribution"
                    Add-CheckFromCondition `
