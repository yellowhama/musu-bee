System Status Report for 2026-05-06 00:51:47
...
hugh51   1090677  100  0.0   9452  4352 pts/6    R+   00:51   0:00 ps aux --sort=-%cpu
hugh51       599 76.7  0.8 1475016 214792 ?      Sl    5월05 606:58 /home/hugh51/.musu/bin/forgejo web -c /home/hugh51/.musu/forgejo/custom/conf/app.ini
hugh51   1090668 33.3  0.0   5776  3584 pts/6    Ss+  00:51   0:00 /usr/bin/bash -c shopt -u promptvars nullglob extglob nocaseglob dotglob; { bash generate_heartbeat.sh 2>&1 | sqz compress --cmd bash; }; __code=$?; pgrep -g 0 >/tmp/shell_pgrep_093340d220d5.tmp 2>&1; exit $__code;
hugh51   1089294 21.2  1.2 27393848 319892 ?     Sl   00:51   0:06 /usr/bin/node --no-warnings=DEP0040 /home/hugh51/.npm-global/bin/gemini --output-format stream-json --prompt heartbeat: 현재 기기 상태 보고해줘 --model gemini-2.5-flash --yolo
hugh51   1089168  7.7  1.1 10632052 276648 ?     Sl   00:51   0:02 node --no-warnings=DEP0040 /home/hugh51/.npm-global/bin/gemini --output-format stream-json --prompt heartbeat: 현재 기기 상태 보고해줘 --model gemini-2.5-flash --yolo
...
hugh51    160771  0.7  0.4 415860 120608 pts/5   Sl+   5월05   4:26 /home/hugh51/.npm-global/lib/node_modules/@openai/codex/node_modules/@openai/codex-linux-x64/vendor/x86_64-unknown-linux-musl/codex/codex
