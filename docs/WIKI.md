...
- current machine-readable single-machine evidence exists at `docs\evidence\single-machine\1.15.0-rc.1\20260530-225842-HUGH_SECOND.evidence.json` on commit `7c7d537`; release audit reports `single_machine_verified=true`
...
- Current single-machine evidence: `docs\evidence\single-machine\1.15.0-rc.1\20260530-225842-HUGH_SECOND.evidence.json` on commit `7c7d537`, dashboard output `MUSU_RELEASE_SMOKE_OK_20260530_2258`, CLI route `MUSU_CLI_ROUTE_OK_20260530_2258`, dashboard task `69d71cea-dec0-47af-a0bb-fdde166c080e`, bridge `http://127.0.0.1:3718`, `doctor_overall=warn` only because the smoke binary is not the installed WindowsApps/MSIX alias.
