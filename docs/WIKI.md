...
- current machine-readable single-machine evidence exists at `docs\evidence\single-machine\1.15.0-rc.1\20260531-202354-HUGH_SECOND.evidence.json` on commit `9223404`; release audit reports `single_machine_verified=true`
...
- Current single-machine evidence: `docs\evidence\single-machine\1.15.0-rc.1\20260531-202354-HUGH_SECOND.evidence.json` on commit `9223404`, dashboard output `MUSU_RELEASE_SMOKE_OK`, CLI route `MUSU_CLI_ROUTE_OK`, dashboard task `89e6ab33-24de-4326-97f2-ebc2f6588209`, bridge `http://127.0.0.1:9818`, `doctor_overall=warn` only because the smoke binary is not the installed WindowsApps/MSIX alias.
