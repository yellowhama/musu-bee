...
- current machine-readable single-machine evidence exists at `docs\evidence\single-machine\1.15.0-rc.1\20260530-224123-HUGH_SECOND.evidence.json` on commit `2eca040`; release audit reports `single_machine_verified=true`
...
- Current single-machine evidence: `docs\evidence\single-machine\1.15.0-rc.1\20260530-224123-HUGH_SECOND.evidence.json` on commit `2eca040`, dashboard output `MUSU_RELEASE_SMOKE_OK_20260530_2240`, CLI route `MUSU_CLI_ROUTE_OK_20260530_2240`, dashboard task `dbb4d9dc-1c94-439c-89ae-98b43285f6b3`, bridge `http://127.0.0.1:3718`, `doctor_overall=warn` only because the smoke binary is not the installed WindowsApps/MSIX alias.
