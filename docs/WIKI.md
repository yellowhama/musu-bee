...
- current machine-readable single-machine evidence exists at `docs\evidence\single-machine\1.15.0-rc.1\20260529-114932-HUGH_SECOND.evidence.json` on commit `a3ace02`; release audit reports `single_machine_verified=true`
