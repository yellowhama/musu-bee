...
- current machine-readable single-machine evidence exists at `docs\evidence\single-machine\1.15.0-rc.1\20260601-012801-HUGH_SECOND.evidence.json` on commit `d482017`; release audit reports `single_machine_verified=true`
...
- Current single-machine evidence: `docs\evidence\single-machine\1.15.0-rc.1\20260601-012801-HUGH_SECOND.evidence.json` on commit `d482017`, dashboard output `MUSU_RELEASE_SMOKE_OK_20260601_012735`, CLI route `MUSU_CLI_ROUTE_OK_20260601_012735`, dashboard task `fe857b79-47af-47d8-abf0-80bcbb63d883`, bridge `http://127.0.0.1:10474`, `dashboard_task_poll_error_count=0`.
...
- Indexer refreshed after wiki/527, the brand/public asset fix, P2P control-plane status update, current post-mDNS single-machine evidence docs, and CoS memory note: `musu indexer sync --work-dir F:\workspace\musu-bee --name musu-bee` indexed 1034 files and 1917 symbols on 2026-06-01.
