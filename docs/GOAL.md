...
**Current operating pointer (2026-05-30)**: the historical V24/V26 planning chain remains useful context, but the live beta-readiness state is now `1.15.0-rc.1`. Future sessions should start with `docs/RELEASE_1_15_0_RC1_FINAL_QUAL_AUDIT_NEXT_STEPS_2026_05_29.md` (wiki/521), `docs/BETA_RELEASE_CHECKLIST_1_15_0_RC1.md`, and this file's revision history before resuming roadmap work.
