...
2026-05-30 Store submission bundle verification update: `verify-store-submission-bundle.ps1` now validates the prepared Store submission bundle before Partner Center upload. `prepare-store-submission-bundle.ps1` writes `SHA256SUMS.txt`, desktop release readiness verifies the latest bundle, and operator action pack generation refuses an invalid Store bundle. Latest verified bundle: `.local-build\msix\submission-bundles\store-reviewed-20260530-093140`.
