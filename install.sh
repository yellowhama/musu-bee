...
if [ $INSTALL_BEE -eq 1 ] && [ -d "$MUSU_ROOT/musu-bee" ]; then
    info "Installing musu-bee dependencies..."
...
echo "Next steps:"
echo "  1. Check status:   musu status"
echo "  2. View logs:      journalctl --user -u musud -f"
echo "  3. Stop services:  musu stop"
echo ""
echo "Ports:"
