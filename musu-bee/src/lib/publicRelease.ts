...
export const DESKTOP_APPINSTALLER_URL = `${DESKTOP_RELEASE_BASE}/musu.appinstaller?rc=1.15.0.22`;
export const DESKTOP_MSIX_URL = `${DESKTOP_RELEASE_BASE}/musu-desktop-x64.msix?rc=1.15.0.22`;
export const DESKTOP_CERT_URL = `${DESKTOP_RELEASE_BASE}/blossompark.musu.cer?rc=1.15.0.22`;
...
export const DESKTOP_INSTALL_SCRIPT_URL = `${DESKTOP_RELEASE_BASE}/Install-MUSU.ps1?rc=1.15.0.22`;
...
export const DESKTOP_REPAIR_FLEET_SCRIPT_URL = `${DESKTOP_RELEASE_BASE}/repair-fleet-node-public-url.ps1?rc=1.15.0.22`;
...
export const DESKTOP_UNINSTALL_SCRIPT_URL = `${DESKTOP_RELEASE_BASE}/Uninstall-MUSU.ps1?rc=1.15.0.22`;
